...
@Component({
  selector: 'app-hyd-team',
  templateUrl: './hyd-team.component.html',
  styleUrls: ['./hyd-team.component.css']
})
export class HydTeamComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Hyderabad');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Hyderabad');
