...
@Component({
  selector: 'app-pune-team',
  // standalone: true,
  // imports: [],
  templateUrl: './pune-team.component.html',
  styleUrl: './pune-team.component.css'
})
export class PuneTeamComponent  implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Pune');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Pune');
