...
@Component({
  selector: 'app-bhu-team',
  // standalone: true,
  // imports: [],
  templateUrl: './bhu-team.component.html',
  styleUrl: './bhu-team.component.css'
})
export class BhuTeamComponent  implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Bhubaneshwar');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Bhubaneshwar');
