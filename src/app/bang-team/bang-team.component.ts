...
@Component({
  selector: 'app-bang-team',
  templateUrl: './bang-team.component.html',
  styleUrls: ['./bang-team.component.css']
})
export class BangTeamComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Bengaluru');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Bengaluru');
