...
@Component({
  selector: 'app-kol-team',
  // standalone: true,
  // imports: [],
  templateUrl: './kol-team.component.html',
  styleUrl: './kol-team.component.css'
})
export class KolTeamComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Kolkata');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Kolkata');
