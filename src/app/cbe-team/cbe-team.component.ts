...
@Component({
  selector: 'app-cbe-team',
  templateUrl: './cbe-team.component.html',
  styleUrls: ['./cbe-team.component.css']
})
export class CBETeamComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Coimbatore');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Coimbatore');
