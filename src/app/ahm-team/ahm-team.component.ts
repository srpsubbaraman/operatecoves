...
@Component({
  ...
  // standalone: true,
  // imports: [],
  templateUrl: './ahm-team.component.html',
  styleUrl: './ahm-team.component.css'
})
export class AhmTeamComponent  implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Ahmedabad');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Ahmedabad');
