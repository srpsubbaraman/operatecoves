...
@Component({
  selector: 'app-del-team',
  // standalone: true,
  // imports: [],
  templateUrl: './del-team.component.html',
  styleUrl: './del-team.component.css'
})
export class DelTeamComponent  implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Delhi');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Delhi');
