...
@Component({
  selector: 'app-chen-team',
  templateUrl: './chen-team.component.html',
  styleUrls: ['./chen-team.component.css']
})
export class ChenTeamComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.groupByProject();
      this.locProjects = this.getProjectsForLocation(data, 'Chennai');
      this.locTeamMembers = this.getTeamMembersForLocation(data, 'Chennai');
